...
import {
  ...
  import { DownloadOutlined, ExportOutlined, EyeOutlined, ImportOutlined, InboxOutlined, MailOutlined, MessageOutlined, PhoneOutlined, PlusOutlined, UserOutlined } from "@ant-design/icons";
...
const MetaList = ({data,currentSearch,sendStatus}:any) => {
  const router= useRouter()
    ...
    const ViewMore = () => {
      try {
        setViewLoading(true);
        router.push(`/admin/pearls/${selectedLead?.user_uuid}`);
        // setModal2Open(false)
      } catch (error) {
...
/> */}
    ...
    <Row justify="space-between" style={{ marginBottom: "0px" }}>
      <div  style={{  padding: "20px" }}>
        ...
        <Search size='large' style={{width:"1200px"}} className='' placeholder="Search by Name & Email" enterButton 
