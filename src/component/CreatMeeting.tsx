...
const CreatMeeting = () => {
  ...
  const generateMeetingLink = async () => {
    ...
    if (selectedOption === "googleMeet") {
      setMeetingLink(
        `https://meet.google.com/new?start=${formattedStartDate}&end=${formattedEndDate}`
      );
  ...
  return (
    <div style={{ maxWidth: 600, margin: "auto", padding: 20 }}>
      ...
      <Form layout="vertical">
          ...
          <Col span={12}>
            <Form.Item label="Start Date" required>
              <DatePicker
                ...
                onChange={(date) =>
                  handleInputChange1(date, startTime, "startDate")
                }
                style={{ width: "100%" }}
              />
            </Form.Item>
          ...
          <Col span={12}>
            <Form.Item label="End Date" required>
              <DatePicker
                ...
                onChange={(date) =>
                  handleInputChange1(date, endTime, "endDate")
                }
                style={{ width: "100%" }}
              />
            </Form.Item>
        ...
        <Form.Item>
          <Button type="primary" block onClick={generateMeetingLink}>
            Generate Link
          </Button>
        </Form.Item>
      </Form>
